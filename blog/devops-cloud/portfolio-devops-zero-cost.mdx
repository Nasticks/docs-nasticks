...
description: "Guide complet : Infrastructure AWS production-ready à 0€/mois. Terraform, GitOps, OIDC (Zero Trust), FinOps, monitoring SRE. Cas d'étude réel avec code, diagrammes et métriques."
icon: "rocket"
date: "2025-01-24"
readingTime: "15 min"
...
- [Conclusion](#conclusion-mon-approche-du-devops)
...
Ma première idée fut de déployer un site sur **Kubernetes (EKS)** ou **Docker (ECS/Fargate)**. Après tout, c'est une techno que je maîtrise.
...
Une approche DevOps pragmatique, c'est de choisir la techno qui résout le problème avec le moins de friction, pas forcément la plus complexe.
</Callout>
...
<Callout type="success" title="Sécurité Production">
...
## Conclusion: Mon approche du DevOps

Beaucoup de gens associent DevOps à "complexité". Kubernetes, Microservices, Docker, ArgoCD...

Pour moi, l'essentiel c'est de savoir dire **"Non, ce projet ne mérite pas cette complexité"** et de choisir la solution la plus simple qui fonctionne.
...
### Pour les Recruteurs
Si tu évalues mon profil: c'est ici que tu vois comment je raisonne l'architecture. Pas de buzzwords, des choix expliqués et un retour concret sur l'implémentation.
...
*Portfolio DevOps v1.0 - Zero Cost, Production-Ready*